...
import { normalizeRender } from "@/lib/ui-utils"
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    render: normalizeRender(render, children, asChild),
    state: {
...
function SidebarMenuButton({
  ...
  const isTooltipEnabled = tooltip && state === "collapsed" && !isMobile
  ...
  const comp = useRender({
    ...
    render: !isTooltipEnabled 
      ? normalizeRender(render, children, asChild)
      : (props) => <TooltipTrigger render={render as any} asChild={asChild} {...props}>{children}</TooltipTrigger>,
    state: {
